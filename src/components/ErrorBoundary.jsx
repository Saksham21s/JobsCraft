      ...
      return (
        <div style={{
            ...
            {`
              ...
              .error-icon {
                ...
                box-shadow: 
                  ...
                  inset -2px -2px 5px rgba(255, 71, 87, 0.2);
              ...
              .refresh-button {
                ...
                cursor: pointer;
                box-shadow: 
                  4px 4px 10px rgba(108, 92, 231, 0.3),
                  -4px -4px 10px rgba(255, 255, 255, 0.8),
              ...
              .refresh-button:hover {
                ...
                box-shadow: 
                  6px 6px 15px rgba(108, 92, 231, 0.4),
              ...
              .refresh-button:active {
                ...
                box-shadow: 
                  2px 2px 5px rgba(108, 92, 231, 0.4),
          ...
          <p className="error-message">
            We encountered an issue while generating your resume. 
